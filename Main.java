...
public class Main {
    public static void main(String[] args) {
        ...
        laptops.add(new Laptop("Acer", 16, 512, "Windows", "Black"));
        laptops.add(new Laptop("Apple", 8, 256, "MacOS", "Silver"));
        laptops.add(new Laptop("Sony", 32, 1024, "Windows", "Gray"));
        laptops.add(new Laptop("Lenovo", 64, 512, "Windows", "Black"));
        laptops.add(new Laptop("IBM", 8, 256, "Windows", "White"));
